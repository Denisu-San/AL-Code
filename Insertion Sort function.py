...
def InSort(array):
    for index in range(1, len(array)):
        ...
        while True:
            if CurrentValue > array[SortedPos]:
                SortedPos = SortedPos + 1
            else:
                InsPos = SortedPos
                InsPosFound = True
        ...
        for ShufflePos in range(index, InsPos, -1):
            array[ShufflePos] = array[ShufflePos - 1]
            array[ShufflePos - 1] = CurrentValue
    return array

a =  [168, 23, 359, 284, 492, 274, 935, 841, 609, 718, 238, 613, 517, 739, 859, 672, 763, 965, 232, 637]
print(InSort(a))